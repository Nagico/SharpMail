...
namespace EmailClient.Migrations
{
    ...
    [Migration("20220725150813_AddMailMoreField")]
    partial class AddMailMoreField
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmailClient.Entities.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EmailClient.Entities.Mail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("EmailClient.Entities.Mail", b =>
                {
                    b.HasOne("EmailClient.Entities.Account", "Account")
                        .WithMany("Mails")
