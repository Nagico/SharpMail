...
namespace EmailClient.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    smtp_ssl = table.Column<bool>(type: "INTEGER", nullable: true, defaultValue: false),
                    pop3_host = table.Column<string>(type: "TEXT", nullable: true),
                    pop3_ssl = table.Column<bool>(type: "INTEGER", nullable: true, defaultValue: false),
                    pop3_port = table.Column<int>(type: "INTEGER", nullable: true),
